...
class CSV_Importer {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      string    $csv_importer    The string used to uniquely identify this plugin.
	 */
	...
	public function __construct() {
		if ( defined( 'CSV_IMPORTER_VERSION' ) ) {
			$this->version = CSV_IMPORTER_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->csv_importer = 'csv-importer';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-csv-importer-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-csv-importer-i18n.php';

	
		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-csv-importer-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-csv-importer-public.php';
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new CSV_Importer_Admin( $this->get_csv_importer(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new CSV_Importer_Public( $this->get_csv_importer(), $this->get_version() );
