...
class CSV_Importer_Admin {
	 ...
	 *
	 * @since    1.0.0
	 * @param      string    $csv_importer       The name of this plugin.
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->csv_importer, plugin_dir_url( __FILE__ ) . 'css/csv-importer-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->csv_importer, plugin_dir_url( __FILE__ ) . 'js/csv-importer-admin.js', array( 'jquery' ), $this->version, false );
